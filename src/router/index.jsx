...
const CakeDetail = lazy(() => import('@/components/pages/CakeDetail'));
...
export const router = createBrowserRouter([
  {
    path: "/",
    element: <Root />, // Don't wrap Root in Suspense - it has Outlet
    children: [
      ...
      {
        path: "/",
        element: <Layout />, // Don't wrap Layout in Suspense - it has Outlet
        children: [
          createRoute({ index: true, element: <Home /> }),
          createRoute({ path: "menu", element: <Menu /> }),
          createRoute({ path: "about", element: <About /> }),
          createRoute({ path: "contact", element: <Contact /> }),
          createRoute({ path: "cake/:id", element: <CakeDetail /> }),
        ],
      },
